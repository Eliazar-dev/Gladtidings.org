      ...
      <div className="auth-card">
        ...
        <form onSubmit={handleLogin}>
          ...
          <div style={{ textAlign: 'right', marginBottom: 18 }}>
            <Link href="/forgot-password" style={{ fontSize: 12, color: 'var(--green3)', fontWeight: 600 }}>Forgot password?</Link>
          </div>
        ...
        <p style={{ textAlign: 'center', marginTop: 20, fontSize: 13, color: 'var(--bark)', opacity: 0.6 }}>
          ...
          <Link href="/signup" style={{ color: 'var(--green3)', fontWeight: 700 }}>Create one</Link>
        </p>
      </div>
    </div>
  )
